...
public class AdminDashboard extends JFrame {
    ...
    private void executeNewSampleVolume() {
        ...
        if (diskNumber != null && drive != null && filesystem != null) {
            runPowerShell("New-Partition -DiskNumber " + diskNumber + " -UseMaximumSize -AssignDriveLetter | Format-Volume -DriveLetter " + drive + " -FileSystem " + filesystem + " -NewFileSystemLabel 'New Volume' -Confirm:$false");
